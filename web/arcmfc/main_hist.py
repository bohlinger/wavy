...
"""
 Make figures
"""
cmd = 'python /home/patrikb/wavy/arcmfc/arcmfc3_figures.py -sat ' + sat + ' -mod ARCMFC3 -reg ARCMFC3 -d 202004'
t = os.system(cmd)
cmd = 'python /home/patrikb/wavy/arcmfc/arcmfc3_figures.py -sat ' + sat + ' -mod ARCMFC3 -reg NordicSeas -d 202004'
t = os.system(cmd)
"""
 Make homepage
"""
