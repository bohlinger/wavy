...
sys.path.append(r'../wavy/op')

import subprocess
import os

#cmd = 'python ../wavy/op/op_collocate.py -m mwam4 -sd 2019020100 -ed 2019022123'
cmd = 'python /home/patrikb/wavy/op/op_collocate.py'
t = os.system(cmd)
#cmd = 'python ../wavy/op/op_validate.py -m mwam4 -sd 2019020100 -ed 2019022123'
