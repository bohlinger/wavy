...
coll_dict = {'basetime':basetime,
            'time':[time_s_lst][0],
            'Tp_model':[mod_lst][0],
            'lats_model':[mod_lat_lst][0],
            'lons_model':[mod_lon_lst][0],
            'Tp_stat_10min':[stat_10min_lst][0],
            'lats_stat':[stat_lat_lst][0],
            'lons_stat':[stat_lon_lst][0],
            'hdist':[dist_lst][0],
            'idx':[idx_lst][0],
            'idy':[idy_lst][0],
            }
