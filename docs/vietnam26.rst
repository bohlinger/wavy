Vietnam Validation Workshop 2026
================================

The following examples are tailored to the **wavy** Vietnam Validation Workshop 2026.
...
#. Create a project directory:
   ...
   .. code::
      ...
      mkdir ~/wavyopen_vietnam26
      mkdir -p ~/wavyopen_vietnam26/config
      mkdir -p ~/wavyopen_vietnam26/scripts
      mkdir -p ~/wavyopen_vietnam26/data
...
#. Specify enfironmental variables
   ...
   .. code::
      ...
      WAVY_CONFIG=/home/{USER}/wavyopen_vietnam26/config/
...
.. code::
   ...
   trgt_tmplt: /home/{USER}/wavyopen_vietnam26/data/name/%Y/%m/
   src_tmplt: /home/{USER}/wavyopen_vietnam26/data/name/%Y/%m/
...
.. code-block:: yaml
   ...
   ecwam_vietnam:
       ...
       coords:
       wavy_input:
           src_tmplt: "/home/patrikb/wavyopen_vietnam26/data/ecwam_vietnam/"
   ...
   swan_vietnam:
       ...
       coords:
       wavy_input:
           src_tmplt: "/home/patrikb/wavyopen_vietnam26/data/swan_vietnam/"
